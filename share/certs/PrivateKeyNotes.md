...
unlocked to sign the BitBridgeCoin-Qt.app bundle.
...
allowing somebody to distribute a BitBridgeCoin-Qt.app or bitbridgecoin-qt-setup.exe with a valid
...
that the bitbridgecoin-qt.exe file inside the installer had not been tampered with.
