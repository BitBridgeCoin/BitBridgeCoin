...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx)
{
    ...
    coinbaseTx.vout[0].nValue = nFees + ( GetBlockSubsidy(nHeight, chainparams.GetConsensus()) / 10 );
    coinbaseTx.vout[1].scriptPubKey = mnPayee;
    coinbaseTx.vout[1].nValue = (9 * GetBlockSubsidy(nHeight, chainparams.GetConsensus())) / 10;
