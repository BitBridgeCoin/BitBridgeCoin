...
/** BitBridgeCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitBridgeCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitBridgeCoinUnits(QObject *parent);

    /** BitBridgeCoin units.
      @note Source: https://en.bitbridgecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef BitBridgeCoinUnits::Unit BitBridgeCoinUnit;
