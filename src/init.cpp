 ...
 * between bitbridgecoind, and bitbridgecoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("bitbridgecoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitbridgecoin/bitbridgecoin>";
    const std::string URL_WEBSITE = "<https://worldmoney.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("bitbridgecoin-loadblk");
...
/** Sanity checks
 *  Ensure that BitBridgeCoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BitBridgeCoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single BitBridgeCoin process is using the data directory.
