...
class BIP66Test(BitBridgeCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitbridgecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitbridgecoind produces more specific reject
            # reasons.
