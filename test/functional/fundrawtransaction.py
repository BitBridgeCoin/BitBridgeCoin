...
from test_framework.test_framework import BitBridgeCoinTestFramework, BITCOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(BitBridgeCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid bitbridgecoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.bitbridgecoind_processes[1].wait(timeout=BITCOIND_PROC_WAIT_TIMEOUT)
