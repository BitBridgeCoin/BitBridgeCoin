...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitBridgeCoinTestFramework
    pass

class ExampleTest(BitBridgeCoinTestFramework):
    # Each functional test is a subclass of the BitBridgeCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BitBridgeCoinTestFramework class so other tests can use it."""
