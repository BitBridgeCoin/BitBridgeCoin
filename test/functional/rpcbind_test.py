...
"""Test running bitbridgecoind with the -rpcbind and -rpcallowip options."""

import socket
import sys

from test_framework.test_framework import BitBridgeCoinTestFramework, SkipTest
from test_framework.util import *
from test_framework.netutil import *


class RPCBindTest(BitBridgeCoinTestFramework):
    ...
    def run_bind_test(self, allow_ips, connect_to, addresses, expected):
        ...
        pid = self.bitbridgecoind_processes[0].pid
