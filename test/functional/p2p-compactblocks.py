...
# TestNode: A peer we use to send messages to bitbridgecoind, and store responses.
...
class CompactBlocksTest(BitBridgeCoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes bitbridgecoind to (reasonably!) disconnect us, so do this last.
    ...
    # bitbridgecoind's choice of nonce.
    ...
    # Test that bitbridgecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitbridgecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitbridgecoind will not send blocktxn responses for blocks whose height is
