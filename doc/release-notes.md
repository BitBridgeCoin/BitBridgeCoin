BitBridgeCoin Core version *0.15.0.1* is now available from:

  <https://bitbridgecoin.org/bin/bitbridgecoin-core-0.15.0.1/>
...
installer (on Windows) or just copy over `/Applications/BitBridgeCoin-Qt` (on Mac)
or `bitbridgecoind`/`bitbridgecoin-qt` (on Linux).
