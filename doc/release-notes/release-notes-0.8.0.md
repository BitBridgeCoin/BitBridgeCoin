BitBridgeCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitbridgecoin/files/BitBridgeCoin/bitbridgecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitBridgeCoin
...
New/changed settings (command-line or bitbridgecoin.conf file)
--------------------------------------------------------
