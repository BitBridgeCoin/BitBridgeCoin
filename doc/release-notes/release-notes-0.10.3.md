BitBridgeCoin Core version 0.10.3 is now available from:

  <https://bitbridgecoin.org/bin/bitbridgecoin-core-0.10.3/>
...
(see https://github.com/bitbridgecoin/bitbridgecoin/pull/6793, as well as the 0.11.0
