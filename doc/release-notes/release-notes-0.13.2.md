BitBridgeCoin Core version 0.13.2 is now available from:

  <https://bitbridgecoin.org/bin/bitbridgecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bitbridgecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitbridgecoin-tx to create v2 transactions (btcdrak)
