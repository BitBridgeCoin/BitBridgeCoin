BitBridgeCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitbridgecoin/files/BitBridgeCoin/bitbridgecoin-0.5.4/
...
http://gitorious.org/bitbridgecoin/bitbridgecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitBridgeCoin-Qt notifications under Growl 1.3.
Increase required age of BitBridgeCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitBridgeCoin properly when installing BitBridgeCoin-Qt over it. (Windows)
