BitBridgeCoin Core version 0.9.4 is now available from:

  https://bitbridgecoin.org/bin/0.9.4/
...
this update is incompatible with the BitBridgeCoin system and could lead to consensus
forks.

BitBridgeCoin Core released binaries from https://bitbridgecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitbridgecoin/+archive/ubuntu/bitbridgecoin
- A third-party or self-compiled BitBridgeCoin Core

upgrade to BitBridgeCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
