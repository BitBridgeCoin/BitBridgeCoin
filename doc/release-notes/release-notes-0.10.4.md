BitBridgeCoin Core version 0.10.4 is now available from:

  <https://bitbridgecoin.org/bin/bitbridgecoin-core-0.10.4/>
...
- #6953 `43c2789` Split bitbridgecoin-tx into its own package
- #6953 `dfe0d4d` Include bitbridgecoin-tx binary on Debian/Ubuntu
